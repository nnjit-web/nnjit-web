...
from relay_models.vgg16 import vgg16_model
from relay_models.resnet_v1_50 import resnet_v1_50_model
from relay_models.mlp import mlp_model
from relay_models.bert_squad import bert_squad_model
from relay_models.roberta import roberta_model
from relay_models.mobilebert import mobilebert_model
from relay_models.bart import bart_model
from relay_models.gpt2 import gpt2_model
from relay_models.t5 import t5_encoder_model, t5_decoder_model
from relay_models.vit import vit_model
from relay_models.unet2d import unet2d_model
...
MODEL_TUNING_CONFIGS = {
  ...
  "enable_graph_executor_run": True,
...
def get_mod_and_params(model_name, dtype="float32"):
  if model_name == "vgg-16":
    ...
    return resnet_v1_50_model()
  elif model_name == "mlp":
    return mlp_model()
  elif model_name == "roberta":
    return roberta_model(dtype)
  elif model_name == "bert-squad":
    return bert_squad_model()
  elif model_name == "mobilebert":
    return mobilebert_model()
  ...
  elif model_name == "t5-decoder":
    return t5_decoder_model()
  elif model_name == "vit":
    return vit_model()
    ...
    for i, task in enumerate(tasks):
      ...
      for target_key in task.target.keys:
        ...
        try:
          ...
          if model_name == "vgg-16" and is_webgpu_backend(backend):
            mean_cost = mean_cost * 5.0
        except TypeError:
          mean_cost = 1e9
