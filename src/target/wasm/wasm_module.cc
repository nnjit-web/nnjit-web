...
PackedFunc WasmModuleNode::GetFunction(const std::string& name,
                                       const ObjectPtr<Object>& sptr_to_self) {
  LOG(FATAL) << "WasmModule: GetFunction not supported";
  return PackedFunc();
}

void WasmModuleNode::SaveToFile(const std::string& file_name, const std::string& format) {
...
std::string WasmModuleNode::GetSource(const std::string& format) {
