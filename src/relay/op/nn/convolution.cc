...
// relay.nn.contrib_conv2d_gemm
TVM_REGISTER_GLOBAL("relay.op.nn._make.contrib_conv2d_gemm")
    .set_body_typed([](Expr data, Expr weight, Array<IndexExpr> strides, Array<IndexExpr> padding,
                       Array<IndexExpr> dilation, int groups, IndexExpr channels,
      ...
      return MakeConvGemm<Conv2DAttrs>(
          data, weight, strides, padding, dilation, groups, channels, kernel_size, data_layout,
          kernel_layout, out_layout, out_dtype, "nn.contrib_conv2d_gemm");
    });
...
RELAY_REGISTER_OP("nn.contrib_conv2d_gemm")
