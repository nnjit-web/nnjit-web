...
def find_example_resource():
    ...
    #html_filename = "rpc_server.html"
    html_filename = "web_kernel_codegen.html"
    index_page = os.path.join(base_path, "web", "apps", "browser", html_filename)
    resource_files = [
...
def main(args):
    ...
    if args.example_rpc:
        ...
        prox = Proxy(
            ...
            timeout_client=args.timeout,
            timeout_server=args.timeout,
            index_page=index,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--timeout", type=int, default=600, help="Timeout of server and client"
    )
    parser.add_argument(
