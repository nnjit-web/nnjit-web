...
def build(
    ...
    """
    #print("build_module.py: target %s" % str(target))
    ...
    #import sys
    #print("build_module.py: input_mod", file=sys.stderr)
    #print(input_mod, file=sys.stderr)
    ...
    #for tar, mod in annotated_mods.items():
    #    import sys
    #    print("build_module.py: annotated_mod", file=sys.stderr)
    ...
    #print("build_module.py: target %s, target_host %s" % (str(target), str(target_host)))
    #print("build_module.py: name %s" % (name))
