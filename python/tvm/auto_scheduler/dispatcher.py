...
class ApplyHistoryBest(DispatchContext):
    ...
    def __init__(self, records, n_lines=None, include_compatible=False, task_flop_dict=None):
        ...
        self._task_flop_dict = task_flop_dict
    ...
    def load(self, records, n_lines=None):
        ...
        for inp, res in joint_records:
            ...
            if print_cost:
                flop = -1
                gflops = -1
                if self._task_flop_dict is not None:
                    flop = self._task_flop_dict[inp.task.workload_key]
                    gflops = flop / cost / 1e9
                print("task_key %s | cost %f | flop %d | GFLOPS %f" % (
                        inp.task.workload_key, cost, flop, gflops))
