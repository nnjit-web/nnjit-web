...
class Module(object):
    ...
    def export_library(self, file_name, fcompile=None, addons=None, workspace_dir=None, **kwargs):
        ...
        #print("module.py: modules " + str(modules))
        ...
        for index, module in enumerate(modules):
            ...
            #print("module.py: save_path_obj %s" % (path_obj))
            start_time = time.time()
            module.save(path_obj)
            end_time = time.time()
            #print("module.py: llvm_module_to_bitcode %3f s" % (end_time - start_time))
        ...
        start_time = time.time()
        result = fcompile(file_name, files, **kwargs)
        end_time = time.time()
        #print("module.py: bitcode_to_wasm_module %3f s" % (end_time - start_time))
