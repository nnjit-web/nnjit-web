...
def get_feature(internal_layer, layers, filters, batch_norm=False):
    ...
    for i, num in enumerate(layers):
        for j in range(num):
            ...
            #    internal_layer, relay.var("conv%s_%s_bias" % (i + 1, j + 1)), bias_add_axis
            #)
            if batch_norm:
        ...
        internal_layer = relay.nn.max_pool2d(data=internal_layer, pool_size=(2, 2), strides=(2, 2), layout=data_layout)
